      ...
      <div className="relative h-[300px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg md:text-xl text-white/90">Complete your purchase</p>
          </div>
        </div>
      </div>
                      ...
                      {isPaymentStart ? (
                        ...
                        <div className="flex items-center gap-2 justify-center">
                          ...
                          <svg className="w-6 h-6" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M20.067 8.478c.492.315.844.827.983 1.42a5.558 5.558 0 0 1-.091 2.011q-1.012 5.085-5.86 5.085h-.001a1.71 1.71 0 0 0-1.636 1.233l-.105.422-.799 5.053-.071.386a.929.929 0 0 1-.92.752h-3.26c-.54 0-.899-.39-.784-.914l2.47-15.692a1.068 1.068 0 0 1 1.058-.862h6.889c1.034 0 2.029.276 2.717.791z"/>
                          </svg>
                        </div>
                      )}
                    </Button>
